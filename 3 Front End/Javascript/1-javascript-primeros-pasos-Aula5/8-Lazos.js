...
if (puedeComprar && destinoDisponible) {
    console.log(
        `Es posible vender el pasaje. La persona puede comprar y el destino está disponible`
    );
} else if (puedeComprar) {
    console.log(
        `No es posible vender el pasaje. La persona puede comprar pero el destino no está disponible`
    );
} else {
