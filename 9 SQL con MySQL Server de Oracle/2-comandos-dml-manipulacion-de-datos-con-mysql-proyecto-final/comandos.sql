...
-- Para finalizar la creación de la base de datos, hacen falta dos tablas que son: tb_producto y tb_vendedor. 
-- (No olvides crear las claves externas que vinculan a tb_producto con tb_items_facturas, a tb_facturas con tb_clientes y a tb_facturas con tb_vendedor).
...
-- que actualiza las edades de los clientes, en la tabla de clientes, siempre que la tabla sufra una inclusión.
